...
<div class="section-right">
    <p class="section-right-title">Create Your Account</p>
    ...
    <label>
        I agree with <a href="guide.php">terms & conditions</a>
        <input id="iaggree-check" type="checkbox"/>
    </label>
    <button id="button-signup" class="section-right-button">sign up</button>
     <a href="index.php" class="section-right-forgotbox">
        Back to main
    </a>
        <div id="login-new" class="section-right-forgotbox">
        Already have account ? <a href="login.php">create one</a>
    </div>
</div>
';
    }
...
<script src="js/login.js?v=' . strtotime(date("Y/m/d H:i:s")) . '"></script>
</body>
</html>';
    }
